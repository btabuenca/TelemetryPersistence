...
import es.upm.btb.telemetrypersistence.device.ISpikeRESTAPIService;
import es.upm.btb.telemetrypersistence.models.TelemetriaEntity;
import es.upm.btb.telemetrypersistence.models.TelemetriaViewModel;
import es.upm.btb.telemetrypersistence.pojo.AuthorizationBearer;
import es.upm.btb.telemetrypersistence.pojo.Co2;
import es.upm.btb.telemetrypersistence.pojo.Credentials;
import es.upm.btb.telemetrypersistence.pojo.Humidity;
import es.upm.btb.telemetrypersistence.pojo.Light;
import es.upm.btb.telemetrypersistence.pojo.Measurement;
import es.upm.btb.telemetrypersistence.pojo.Sensors;
import es.upm.btb.telemetrypersistence.pojo.SoilTemp1;
import es.upm.btb.telemetrypersistence.pojo.SoilTemp2;
import es.upm.btb.telemetrypersistence.pojo.Temperature;
import es.upm.btb.telemetrypersistence.utils.CSVReader;
import es.upm.btb.telemetrypersistence.views.TelemetriasListAdapter;
